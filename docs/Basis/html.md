...
[preload 让加载和解析解耦](https://blog.csdn.net/weixin_34190136/article/details/91369178)
...
## async和defer
- `async` 下载和执行都是异步
- `defer` 异步下载，script延时至元素解析完，DOMContentLoaded触发之前完成
- `load` 会等`async`和`defer`完成后触发
